import { requireAdmin } from "@/lib/services/admin/requireAdmin";
...
function maskStatus(value: string | undefined) {
  if (!value) return { configured: false, hint: "not set" };
...
export default async function AdminPage() {
  ...
  const keys = {
    Groq: { ...maskStatus(process.env.GROQ_API_KEY), provider: "groq" as const },
    AssemblyAI: { ...maskStatus(process.env.ASSEMBLYAI_API_KEY), provider: "assemblyai" as const },
  };
